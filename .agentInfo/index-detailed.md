...
- **bench-sequence, bench-mode**: [notes/bench-sequence.md](notes/bench-sequence.md) - Runs automated tests with safe random spawns, random directions, scaled thresholds and a GUI spawn counter.
