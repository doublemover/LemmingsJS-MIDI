...
- **renderCursorSizes.js** – outputs the cursor sprite rendered at every width/height pair from 2×2 up to 96×96. The script resets the binary reader offset each iteration to avoid wraparound. Usage: `node tools/renderCursorSizes.js [pack] [out dir]`.
