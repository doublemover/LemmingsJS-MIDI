...
- **renderCursorSizes.js** – outputs the cursor sprite rendered at every width/height pair from 10×10 to 64×64. The script resets the binary reader offset each iteration to avoid wraparound. Usage: `node tools/renderCursorSizes.js [pack] [out dir]`.
