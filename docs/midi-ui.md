...
- Modulation: set global intensity, accent, duration defaults/range, view pan,
  and add, edit, or remove compact position lanes with axis operators for note,
  velocity, pan, duration, timbre, and envelope targets. Global envelope
