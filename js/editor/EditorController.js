...
class EditorController {
  ...
  /**
   * Runs grouped editor mutations as one undo snapshot when the history backend
   * supports transactions. Falls back to direct execution for simple stubs/tests.
   */
